...
describe('Router Helpers', () => {
  describe('getExpressRouter', () => {
    it('[HELP-R0010] should return router with useMiddlewares function', () => {
    ...
    it('[HELP-R0020] should apply middleware to all HTTP methods', () => {
      const router = getExpressRouter()
    ...
    it('[HELP-R0030] should correctly chain middleware and handlers', async () => {
      const router = getExpressRouter()
    ...
    it('[HELP-R0040] should filter out falsy middleware', () => {
      const router = getExpressRouter()
      const middleware1 = jest.fn((req, res, next) => next())
      const middleware2 = jest.fn((req, res, next) => next())
  ...
  describe('nextRouteIf', () => {
    it('[HELP-R0050] should call next("route") when condition is true', async () => {
    ...
    it('[HELP-R0060] should call next() when condition is false', async () => {
    ...
    it('[HELP-R0070] should work with synchronous condition function', async () => {
    ...
    it('[HELP-E0060] should handle condition function throwing error', async () => {
